...
CeDImu :
	...
	$(CXX) $(CXXFLAGS) -I$(wxIPath) -I$(wxIMSWU) $(defines) -c src/utils.cpp -o bin/obj/utils.o
	...
	$(CXX) $(CXXFLAGS) -I$(wxIPath) -I$(wxIMSWU) $(defines) -c src/GUI/RAMWatchFrame.cpp -o bin/obj/RAMWatchFrame.o

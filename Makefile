...
bin/obj/SCC68070.o bin/obj/SCC66470.o bin/obj/Interpreter.o bin/obj/ConditionalTests.o bin/obj/InstructionSet.o
...
CeDImu :
	...
	$(CXX) $(CXXFLAGS) -O3 -I$(wxIPath) -I$(wxIMSWU) $(defines) $(wxLib) -c src/utils.c -o bin/obj/utils.o

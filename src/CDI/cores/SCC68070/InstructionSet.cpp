...
uint16_t SCC68070::TRAP()
{
    ...
    throw SCC68070::Exception(as<ExceptionVector>(Trap0Instruction + vector), PeekNextWord());
    // May not be the most efficient but catches every exception easily.
}

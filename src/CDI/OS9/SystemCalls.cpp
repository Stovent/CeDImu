...
std::string systemCallInputsToString(const SystemCallType call, const std::map<SCC68070::Register, uint32_t>& regs, const std::function<const uint8_t*(const uint32_t)>& get)
{
    ...
    case SystemCallType::I_Attach:  snprintf(args, 256, "(a0).s=\"%s\" d0.b=%hhu", GETSTR(A0), REG(D0)); break;
    case SystemCallType::I_Detach:  snprintf(args, 256, "a2=0x%X", REG(A2)); break;
    case SystemCallType::I_Dup:     snprintf(args, 256, "d0.w=%hu", REG(D0)); break;
    case SystemCallType::I_Create:  snprintf(args, 256, "(a0).s=\"%s\" d0.b=%hhu d1.w=%hu d2.l=%u", GETSTR(A0), REG(D0), REG(D1), REG(D2)); break;
    case SystemCallType::I_Open:    snprintf(args, 256, "(a0).s=\"%s\" d0.b=%hhu", GETSTR(A0), REG(D0)); break;
    case SystemCallType::I_MakDir:  snprintf(args, 256, "(a0).s=\"%s\" d0.b=%hhu d1.w=%hu d2.l=%u", GETSTR(A0), REG(D0), REG(D1), REG(D2)); break;
    case SystemCallType::I_ChgDir:  snprintf(args, 256, "(a0).s=\"%s\" d0.b=%hhu", GETSTR(A0), REG(D0)); break;
    case SystemCallType::I_Delete:  snprintf(args, 256, "(a0).s=\"%s\" d0.b=%hhu", GETSTR(A0), REG(D0)); break;
    case SystemCallType::I_Seek:    snprintf(args, 256, "d0.w=%hu d1.l=%u", REG(D0), REG(D1)); break;
    case SystemCallType::I_Read:    snprintf(args, 256, "d0.w=%hu d1.l=%u a0=0x%X", REG(D0), REG(D1), REG(A0)); break;
...
std::string systemCallOutputsToString(const SystemCallType call, const std::map<SCC68070::Register, uint32_t>& regs, const std::function<const uint8_t*(const uint32_t)>& get)
{
    ...
    case SystemCallType::I_Dup:     snprintf(args, 256, "d0.w=%hu", REG(D0)); break;
    case SystemCallType::I_Create:  snprintf(args, 256, "(a0).s=\"%s\" d0.w=%hu", GETSTR(A0), REG(D0)); break;
    case SystemCallType::I_Open:    snprintf(args, 256, "(a0).s=\"%s\" d0.w=%hu", GETSTR(A0), REG(D0)); break;
    ...
    case SystemCallType::I_Read:    snprintf(args, 256, "d1.l=%u", REG(D1)); break;

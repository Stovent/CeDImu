...
inline std::string disassembleOS9Event(const uint16_t word, const uint32_t D[8], const uint32_t A[8])
{
    char event[256] = {0};
    switch(word)
    {
    case 0x0000: snprintf(event, 256, "Ev$Link { (a0).s:\"%s\" } => { (a0).s d0.l }", "A0"); break;
	case 0x0001: snprintf(event, 256, "Ev$UnLnk { d0.l:%d }", D[0]); break;
	case 0x0002: snprintf(event, 256, "Ev$Creat { (a0).s:\"%s\" d0.l:%d d2.w:%hd d3.w:%hd } => { (a0).s d0.l }", "A0", D[0], D[2], D[3]); break;
	case 0x0003: snprintf(event, 256, "Ev$Delet { (a0).s:\"%s\" } => { (a0).s }", "A0"); break;
...
inline std::string disassembleOS9Call(const uint16_t word, const uint32_t D[8], const uint32_t A[8])
{
    char call[256] = {0};
    switch(word)
    {
    case 0x0000: snprintf(call, 256, "F$Link { (a0).s:\"%s\" d0.w:%hd } => { (a0).s a1 a2 d0.w d1.w }", "TODO", D[0]); break;
    case 0x0001: snprintf(call, 256, "F$Load { (a0).s:\"%s\" d0.b:%hhd d1.l:%d } => { (a0).s a1 a2 d0.w d1.w }", "TODO", D[0], D[1]); break;
    case 0x0002: snprintf(call, 256, "F$UnLink { a2:0x%X }", A[2]); break;
    case 0x0003: snprintf(call, 256, "F$Fork { (a0).s:\"%s\" a1:0x%X d0.w:%hd d1.l:%d d2.l:%d d3.w:%hd d4.w:%hd } => { (a0).s d0.w }", "TODO", A[1], D[0], D[1], D[2], D[3], D[4]); break;
    case 0x0004: snprintf(call, 256, "F$Wait {} => { d0.w:%hd d1.w:%hd }", D[0], D[1]); break;
    case 0x0005: snprintf(call, 256, "F$Chain { (a0).s:\"%s\" a1:0x%X d0.w:%hd d1.l:%d d2.l:%d d3.w:%hd d4.w:%hd }", "TODO", A[1], D[0], D[1], D[2], D[3], D[4]); break;
    ...
    case 0x0010: snprintf(call, 256, "F$PrsNam { (a0).s:\"%s\" } => { a0 d0.b d1.w a1 }", "TODO"); break;
    case 0x0011: snprintf(call, 256, "F$CmpNam { (a0).s:\"%s\" (a1).s:\"%s\" d1.w:%hd }", "TODO", "TODO", D[1]); break;
    ...
    case 0x001D: snprintf(call, 256, "F$UnLoad { (a0).s:\"%s\" d0.w:%hd } => { (a0).s }", "TODO", D[0]); break;
    ...
    case 0x0021: snprintf(call, 256, "F$TLink { (a0).s:\"%s\" d0.w:%hd } => { (a0).s d0.w d1.w a1 a2 }", "TODO", D[0]); break;
    case 0x0022: snprintf(call, 256, "F$DFork { (a0).s:\"%s\" a1:0x%X a2:0x%X d0.w:%hd d1.l:%d d2.l:%d d3.w:%hd d4.w:%hd } => { (a0).s a2 d0.w }", "TODO", A[1], A[2], D[0], D[1], D[2], D[3], D[4]); break;
    ...
    case 0x0025: snprintf(call, 256, "F$DatMod { (a0).s:\"%s\" d0.l:%d d1.w:%hd d2.w:%hd d3.w:%hd d4.l:%d } => { (a0).s d0.w d1.w a1 a2 }", "TODO", D[0], D[1], D[2], D[3], D[4]); break;
    ...
    case 0x0053: snprintf(call, 256, "F$Event (%s) { d1.w:%hd }", disassembleOS9Event(D[1], D, A).c_str(), D[1]); break;
    ...
    case 0x0080: snprintf(call, 256, "I$Attach { (a0).s:\"%s\" d0.b:%hhd } => { a2 }", "TODO", D[0]); break;
    case 0x0081: snprintf(call, 256, "I$Detach { a2:0x%X }", A[2]); break;
    case 0x0082: snprintf(call, 256, "I$Dup { d0.w:%hd } => { d0.w }", D[0]); break;
    case 0x0083: snprintf(call, 256, "I$Create { (a0).s:\"%s\" d0.b:%hhd d1.w:%hd d2.l:%d } => { (a0).s d0.w }", "TODO", D[0], D[1], D[2]); break;
    case 0x0084: snprintf(call, 256, "I$Open { (a0).s:\"%s\" d0.b:%hhd } => { d0.w a0 }", "TODO", D[0]); break;
    case 0x0085: snprintf(call, 256, "I$MakDir { (a0).s:\"%s\" d0.b:%hhd d1.w:%hd d2.l:%d } => { (a0).s }", "TODO", D[0], D[1], D[2]); break;
    case 0x0086: snprintf(call, 256, "I$ChgDir { (a0).s:\"%s\" d0.b:%hhd } => { (a0).s }", "TODO", D[0]); break;
    case 0x0087: snprintf(call, 256, "I$Delete { (a0).s:\"%s\" d0.b:%hhd } => { (a0).s }", "TODO", D[0]); break;
